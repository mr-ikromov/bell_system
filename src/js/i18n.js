...
const DAYS = {
  uz: { short: ['Du','Se','Ch','Pa','Ju','Sh','Ya'], full:  ['Dushanba','Seshanba','Chorshanba','Payshanba','Juma','Shanba','Yakshanba'] },
  en: { short: ['Mo','Tu','We','Th','Fr','Sa','Su'], full:  ['Monday','Tuesday','Wednesday','Thursday','Friday','Saturday','Sunday'] },
  ru: { short: ['Пн','Вт','Ср','Чт','Пт','Сб','Вс'], full:  ['Понедельник','Вторник','Среда','Четверг','Пятница','Суббота','Воскресенье'] },
};
